package org.example.coursework.aop;
...
public class AspectClass {
    ...
    @Pointcut("within(org.example.coursework.aop.*Service)")
    public void checkAllLogs(){}

    @Pointcut("execution(public void org.example.coursework.aop.*Service.createOrder(..))")
